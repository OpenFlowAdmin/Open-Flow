...
namespace OpenFlow_PluginFramework.UnitTests.Primitives.UnitTests.TypeDefinition.UnitTests
{
    public class TypeDefinitionTests
    {
        ...
        {
            var result = _sut.TrySetValue(10.0, out _);
        ...
        {
            var result = _sut.TrySetValue(10, out _);
        ...
        {
            var result = _sut.TrySetValue("Test", out _);
        ...
        public void WithConstraint_ShouldConstrain_WithLambda()
        {
            ...
            var setValueBool = _sut.TrySetValue(10.0, out object result);
