namespace OpenFlow_PluginFramework.NodeSystem.NodeComponents.Fields
{
    ...
    public partial class ValueField : NodeField
    {
        ...
        private readonly Dictionary<object, OpenFlowValue> valueStore = new Dictionary<object, OpenFlowValue>();
        ...
        public object this[object key]
        {
            ...
            set
            {
                ...
                {
                    AddValue(key, new ITypeDefinition[] { new AutoTypeDefinition(value) });
                }
            }
        }
        ...
        private void AddValue(object key, ITypeDefinition[] typeDefs)
        {
    ...
    public partial class ValueField
    {
        ...
        public ValueField WithValue<T>(object key, T value = default, string editorName = null, string displayName = null) => WithValue(key, new ITypeDefinition[] { new TypeDefinition<T>() { DefaultValue = value, EditorName = editorName, DisplayName = displayName } });

        public ValueField WithValue(object key, ITypeDefinition[] typeDefinitions)
        {
        ...
        public ValueField WithInput(ITypeDefinition[] typeDefinition) => WithValue(InputKey, typeDefinition);
        ...
        public ValueField WithOutput(ITypeDefinition[] typeDefinition) => WithValue(OutputKey, typeDefinition);
    }
}
