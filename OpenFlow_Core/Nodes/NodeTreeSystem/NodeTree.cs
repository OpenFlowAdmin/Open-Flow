namespace OpenFlow_Core.Nodes.NodeTreeSystem
{
    ...
    {
        private readonly Dictionary<Connector, Connector> connections = new Dictionary<Connector, Connector>();

        public ObservableCollection<NodeBase> Nodes { get; private set; } = new ObservableCollection<NodeBase>();
