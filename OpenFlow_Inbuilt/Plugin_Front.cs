namespace OpenFlow_Inbuilt
{
    ...
    public class Plugin_Front : IPlugin
    {
        ...
        public Plugin_Front()
        {
            editors = DataTemplatesFromFolder(@"F:\OneDrive\Documents\VS Projects\Open Flow\OpenFlow_Inbuilt\Editors");
            displays = DataTemplatesFromFolder(@"F:\OneDrive\Documents\VS Projects\Open Flow\OpenFlow_Inbuilt\Displays");
        }
